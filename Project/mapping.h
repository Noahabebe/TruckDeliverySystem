...
#define YELLOW 8
#define DIVERSION 16
#define TRUCKWEIGHT 2500
#define TRUCKSIZE 50
#define SMALLSIZE 0.5
#define MEDIUMSIZE 1
#define LARGESIZE 5
...
/**
* Create a map with the position of all buildings.
* @returns - a map with the position of all buildings added.
*/
...
* G = green route
* Y = yellow route
* . = B & G blue and green routes overlap
* - = B & Y blue and yellow routes overlap
* * = G & Y green and yellow routes overlap
* + = B & G & Y all routes overlap
* P = a shortest path or route from one point to another
* @param map - map to print
* @param base1 - if true print row indices from 1 and upwards otherwise print from 0 and upwards
* @param alphaCols - if true print column header as letters, otherwise print column header as numbers
*/
